        ...
        <div class="container">
          ...
          <div class="content">
            ...
            <div class="otp-box">
              ...
              <div class="expiry">Ã¢ÂÂ± This code expires in 10 minutes</div>
            </div>
            <div class="message">Enter this code in the verification screen to continue accessing your secure vault.</div>
            <div class="warning"><strong>Ã¢Å¡ Ã¯Â¸Â Security Notice:</strong> If this wasn't you, your account may be compromised. Please secure your account immediately.</div>
          </div>
          <div class="footer">
            <p>This is an automated message from AirVault Security System.</p>
            <p>Ã‚Â© ${new Date().getFullYear()} AirVault. All rights reserved.</p>
          </div>
        </div>
      </body>
      </html>
